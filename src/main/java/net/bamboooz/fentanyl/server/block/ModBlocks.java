package net.bamboooz.fentanyl.server.block;

import net.bamboooz.fentanyl.Fentanyl;
import net.bamboooz.fentanyl.server.block.syringe.FentanylSyringeBlock;
import net.bamboooz.fentanyl.server.block.syringe.NaloxoneSyringeBlock;
import net.bamboooz.fentanyl.server.block.syringe.SyringeBlock;
...
public class ModBlocks {
    public static final Block FENTANYL_BLOCK = registerBlock("fentanyl_block", new Block(FabricBlockSettings.copyOf(Blocks.CYAN_CONCRETE_POWDER).sounds(BlockSoundGroup.SAND)));
