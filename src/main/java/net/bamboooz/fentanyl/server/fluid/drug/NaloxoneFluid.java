package net.bamboooz.fentanyl.server.fluid.drug;
...
public abstract class NaloxoneFluid extends FlowableFluid {
    public NaloxoneFluid() {

    }

    public Fluid getFlowing() {
        return ModFluids.NALOXONE_FLOWING;
    }

    public Fluid getStill() {
        return ModFluids.NALOXONE_STILL;
    }

    public Item getBucketItem() {
        return ModItems.NALOXONE_BUCKET;
    }
    ...
    public BlockState toBlockState(FluidState state) {
        return ModBlocks.NALOXONE_FLUID_BLOCK.getDefaultState().with(FluidBlock.LEVEL, getBlockStateLevel(state));
    }

    public boolean matchesType(Fluid fluid) {
        return fluid == ModFluids.NALOXONE_STILL || fluid == ModFluids.NALOXONE_FLOWING;
    }
    ...
    public static class Flowing extends NaloxoneFluid {
    ...
    public static class Still extends NaloxoneFluid {
        @Override
        protected boolean isInfinite(World world) {
            return false;
        }
